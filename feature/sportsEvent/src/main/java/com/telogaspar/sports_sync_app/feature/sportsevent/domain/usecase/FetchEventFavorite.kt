...
class FetchEventFavorite(private val repository: FavoriteListLocalDataSource) {

    operator fun invoke() : Flow<Set<String>> = repository.getFavorite(Type.FAVORITE_EVENTS)
}